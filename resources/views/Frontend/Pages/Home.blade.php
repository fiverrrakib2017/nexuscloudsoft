...
@section('content')
      ...
      <div class="container">
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
            <h1 data-aos="fade-up" class="fw-bold">Simplify Your ISP Business with One Powerful Platform</h1>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-lg-start align-items-center gap-3 mt-4" data-aos="fade-up" data-aos-delay="200">
              <a href="#about" class="btn-get-started d-inline-flex align-items-center justify-content-center">
                <span>Get Started</span>
                <i class="bi bi-arrow-right ms-2"></i>
              </a>
              <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8" class="glightbox btn-watch-video d-inline-flex align-items-center justify-content-center">
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img text-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="images/hero_section.png" class="img-fluid animated" alt="Modern Business Solutions">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>WHO WE ARE</h3>
              <h2>We Are a Team of Innovators Dedicated to Empowering Your Brand</h2>
              <p>
                We combine strategy, creativity, and technology to help your business thrive in the digital world. Our team crafts customized web solutions, driving measurable results and building meaningful connections between you and your customers.
              </p>
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/services.jpg" class="img-fluid" alt="About Our Company">
          </div>
    ...
    <section id="values" class="values section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Why Choose Us</h2>
            <p>Built to Simplify & Grow Your ISP Business</p>
        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card">
                        ...
                        <img src="assets/img/values-1.png" class="img-fluid" alt="Automation">

                        <h3>Complete ISP Automation</h3>

                        <p>

                            Automate customer billing, MikroTik management,
                            invoice generation, service activation, suspension,
                            and bandwidth control—all from a single dashboard.
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="card">
                        ...
                        <img src="assets/img/values-2.png" class="img-fluid" alt="Network Monitoring">

                        <h3>Advanced Network Monitoring</h3>

                        <p>

                            Monitor OLTs, ONUs, customer connectivity,
                            optical power, bandwidth usage,
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="card">
                        ...
                        <img src="assets/img/values-3.png" class="img-fluid" alt="Scalable Solution">

                        <h3>Scalable & Secure Platform</h3>
                        ...
                        <p>
                            ...
                            and cloud-ready deployment for growing ISPs.
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Our Solutions</h2>
            <p>Everything You Need to Run Your ISP Business</p>
        </div>
